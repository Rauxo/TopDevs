  ...
  return (
    <div className="min-h-[calc(100vh-72px)] bg-[#f8fafc] relative overflow-hidden flex flex-col">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute -top-[10%] -right-[5%] w-[40%] h-[40%] bg-emerald-500/5 rounded-full blur-[120px]"></div>
      ...
      <div className="flex-1 flex flex-col relative z-10">
        ...
        <div className="bg-white/70 backdrop-blur-md border-b border-slate-200/60 px-8 py-5 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-emerald-500/20">
              <MessageSquare size={24} />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-2xl font-black text-slate-900 tracking-tight">Messages</h1>
                <span className="px-2 py-0.5 bg-emerald-100 text-emerald-700 text-[10px] font-black uppercase tracking-widest rounded-md">Real-time</span>
              </div>
