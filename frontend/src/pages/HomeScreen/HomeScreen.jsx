    ...
    <Layout>
      ...
      <section className="relative min-h-screen w-full flex items-center overflow-hidden bg-gradient-to-br from-emerald-50 via-cyan-50 to-sky-100">
        ...
        <div className="relative z-10 w-full md:w-[55%] px-6 md:pl-24">
          <span className="inline-block text-xs font-bold tracking-widest uppercase text-emerald-600 bg-emerald-100 px-3 py-1 rounded-full mb-4">
            🚀 Developer Platform
          </span>
          ...
          <p className="text-xl md:text-2xl font-medium mt-4 text-slate-600">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <button
              ...
              className="h-13 px-8 rounded-xl font-bold text-base text-white bg-gradient-to-r from-emerald-500 to-sky-500 shadow-[0_4px_20px_rgba(16,185,129,0.35)] hover:shadow-[0_8px_28px_rgba(16,185,129,0.5)] hover:-translate-y-0.5 transition-all duration-200 cursor-pointer border-none"
            >
              Get Started →
            </button>
            <button
