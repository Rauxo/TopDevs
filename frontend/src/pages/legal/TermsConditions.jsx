      ...
      <div className="max-w-4xl mx-auto py-20 px-6">
        <div className="space-y-16">
          <section className="relative group">
            <span className="absolute -left-8 top-0 text-4xl font-black text-blue-100 group-hover:text-blue-200 transition-colors">01</span>
          ...
          <section className="relative group">
             <span className="absolute -left-8 top-0 text-4xl font-black text-blue-100 group-hover:text-blue-200 transition-colors">02</span>
          ...
          <section className="relative group">
             <span className="absolute -left-8 top-0 text-4xl font-black text-blue-100 group-hover:text-blue-200 transition-colors">03</span>
          ...
          <section className="relative group">
             <span className="absolute -left-8 top-0 text-4xl font-black text-blue-100 group-hover:text-blue-200 transition-colors">04</span>
